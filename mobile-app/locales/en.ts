export default {
  ...
  payments: {
    ...
    deletePaymentConfirm: 'Are you sure you want to delete the payment for',
  ...
  qr: {
    ...
    successfullyCheckedInFor: 'Successfully checked in for "{{title}}"',
    childCheckedIn: '{{name}} has been checked in',
    childCheckedInFor: '{{name}} has been checked in for "{{title}}"',
    attendanceNotRecorded: 'Attendance Not Recorded',
    checkInFailed: 'Check-in failed. Please try again.',
    tooEarly: 'Check-in is only available on the event day.',
    eventEnded: 'The event has ended. Check-in is no longer available.',
