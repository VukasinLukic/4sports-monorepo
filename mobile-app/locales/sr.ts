export default {
  ...
  payments: {
    ...
    deletePaymentConfirm: 'Da li ste sigurni da želite da obrišete uplatu za',
  ...
  profile: {
    ...
    tapToChangePhoto: 'Tapnite da promenite sliku',
    fullName: 'Ime i prezime',
    ...
    photoPermission: 'Dozvolite pristup galeriji da biste promenili profilnu sliku.',
    pickImageError: 'Greška pri izboru slike. Pokušajte ponovo.',
    uploadError: 'Slanje slike nije uspelo. Pokušajte ponovo.',
  ...
  qr: {
    ...
    notForAttendance: 'Ovaj QR kod nije za evidentiranje prisustva.',
    profileNotLoaded: 'Profil nije učitan. Pokušajte ponovo.',
    couldNotRead: 'Ne mogu da pročitam ovaj QR kod. Pokušajte ponovo.',
    attendanceRecorded: 'Prisustvo evidentirano! ✓',
    successfullyCheckedIn: 'Uspešno ste prijavljeni',
    successfullyCheckedInFor: 'Uspešno ste prijavljeni za "{{title}}"',
    childCheckedIn: '{{name}} je prijavljen',
    childCheckedInFor: '{{name}} je prijavljen za "{{title}}"',
    attendanceNotRecorded: 'Prisustvo nije evidentirano',
    checkInFailed: 'Evidentiranje nije uspelo. Pokušajte ponovo.',
    tooEarly: 'Check-in je moguć samo na dan događaja.',
    eventEnded: 'Događaj je prošao. Check-in više nije moguć.',
