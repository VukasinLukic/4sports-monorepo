...
export default function ParentNewsFeed() {
  ...
  const fetchData = useCallback(async () => {
    try {
      // Fetch posts for parent's children's groups
      const response = await api.get('/posts/my-children');
    ...
    <Card style={styles.emptyCard}>
      <Card.Content style={styles.emptyContent}>
        ...
        <Text style={styles.emptyText}>
          News and updates from your child's club will appear here
        </Text>
      </Card.Content>
    </Card>
  );
  ...
  const renderHeader = () => (
    <View style={styles.header}>
      ...
      <Text style={styles.subtitle}>Updates from your child's club</Text>
    </View>
  );
